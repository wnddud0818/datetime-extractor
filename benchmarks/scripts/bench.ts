...
async function runRealisticRule100(cliArgs: string[]): Promise<void> {
  ...
  const baseCases: Case[] = [
    ...
    { id: 48, category: "5.absolute", text: "20241231 결산 자료", mode: "range", expectedRanges: [exactDay(2024, 12, 31)] },
    {
      ...
      text: "12월 25일 휴무 맞아?",
      mode: "range",
      expectedRanges: [exactDay(2025, 12, 25)],
      note: "기본 ambiguityStrategy=past 기준",
    },
    {
      id: 50,
      category: "5.absolute",
      text: "5월 5일 쉬는 날이지?",
      mode: "range",
      expectedRanges: [exactDay(2025, 5, 5)],
      note: "기본 ambiguityStrategy=past 기준",
    },
    ...
    { id: 116, category: "12.handmade.medium", text: "작년 4분기 실적 보여줘", mode: "range", expectedRanges: [quarterRange(2025, 4)] },
    {
      ...
      text: "4월 30일에 회의실 비어?",
      mode: "range",
      expectedRanges: [exactDay(2025, 4, 30)],
      note: "기본 ambiguityStrategy=past 기준",
    },
    ...
    { id: 120, category: "12.handmade.medium", text: "오늘 저녁에 통화 가능해?", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 18, 18, 0, 21, 0)] },
    {
      ...
      mode: "datetime",
      expectedRanges: [pointTime(2025, 4, 21, 14, 30)],
      note: "기본 ambiguityStrategy=past 기준",
    },
    ...
    },
    {
      id: 144,
      category: "13.handmade.complex",
      text: "올해 3월 말 결산 자료 보여줘",
      mode: "range",
      expectedRanges: [explicitRange(2026, 3, 21, 2026, 3, 31)],
      note: "현재 스펙상 explicit monthPart late = 21일~말일",
    },
    {
      id: 145,
      category: "13.handmade.complex",
    ...
    // 15-19. handwritten userlike 100
    { id: 151, category: "15.userlike.relative", text: "오늘 건만 다시 보여줘", mode: "range", expectedRanges: [dayRange(REF)] },
    { id: 152, category: "15.userlike.relative", text: "어제 온 문자만 찾아줘", mode: "range", expectedRanges: [dayRange(addDays(REF, -1))] },
    { id: 153, category: "15.userlike.relative", text: "그저께 먹은 약 시간 기억나?", mode: "range", expectedRanges: [dayRange(addDays(REF, -2))] },
    { id: 154, category: "15.userlike.relative", text: "엊그제 올린 파일 어디 있어?", mode: "range", expectedRanges: [dayRange(addDays(REF, -2))] },
    { id: 155, category: "15.userlike.relative", text: "내일 병원 예약 잡혀 있나?", mode: "range", expectedRanges: [dayRange(addDays(REF, 1))] },
    { id: 156, category: "15.userlike.relative", text: "모레 비행기 맞지?", mode: "range", expectedRanges: [dayRange(addDays(REF, 2))] },
    { id: 157, category: "15.userlike.relative", text: "글피 도착 예정이야", mode: "range", expectedRanges: [dayRange(addDays(REF, 3))] },
    { id: 158, category: "15.userlike.relative", text: "그글피에 바로 출근 가능해?", mode: "range", expectedRanges: [dayRange(addDays(REF, 4))] },
    { id: 159, category: "15.userlike.relative", text: "사흘 전에 보낸 메일 찾아줘", mode: "range", expectedRanges: [dayRange(addDays(REF, -3))] },
    { id: 160, category: "15.userlike.relative", text: "나흘 뒤에 다시 알려줘", mode: "range", expectedRanges: [dayRange(addDays(REF, 4))] },
    { id: 161, category: "15.userlike.relative", text: "닷새 뒤 체크인하면 돼?", mode: "range", expectedRanges: [dayRange(addDays(REF, 5))] },
    { id: 162, category: "15.userlike.relative", text: "엿새 뒤 일정도 잡아줘", mode: "range", expectedRanges: [dayRange(addDays(REF, 6))] },
    { id: 163, category: "15.userlike.relative", text: "여드레 전에 올린 공지 보여줘", mode: "range", expectedRanges: [dayRange(addDays(REF, -8))] },
    { id: 164, category: "15.userlike.relative", text: "열흘 뒤에 만료되는 거 뭐 있어?", mode: "range", expectedRanges: [dayRange(addDays(REF, 10))] },
    { id: 165, category: "15.userlike.relative", text: "보름 전에 신청한 건 처리됐어?", mode: "range", expectedRanges: [dayRange(addDays(REF, -15))] },
    { id: 166, category: "15.userlike.relative", text: "일주일 뒤 다시 보면 돼?", mode: "range", expectedRanges: [dayRange(addWeeks(REF, 1))] },
    { id: 167, category: "15.userlike.relative", text: "한 달 전 카드값이랑 비교해줘", mode: "range", expectedRanges: [dayRange(addMonths(REF, -1))] },
    { id: 168, category: "15.userlike.relative", text: "2개월 뒤에 만기네", mode: "range", expectedRanges: [dayRange(addMonths(REF, 2))] },
    { id: 169, category: "15.userlike.relative", text: "3개월 뒤 다시 연락줘", mode: "range", expectedRanges: [dayRange(addMonths(REF, 3))] },
    { id: 170, category: "15.userlike.relative", text: "1년 전 계약서 찾아줘", mode: "range", expectedRanges: [dayRange(addYears(REF, -1))] },

    { id: 171, category: "16.userlike.week", text: "이번주 전체 일정 좀 봐줘", mode: "range", expectedRanges: [weekRange(0)] },
    { id: 172, category: "16.userlike.week", text: "지난주에 처리한 건만 묶어줘", mode: "range", expectedRanges: [weekRange(-1)] },
    { id: 173, category: "16.userlike.week", text: "담주 스케줄 먼저 보여줘", mode: "range", expectedRanges: [weekRange(1)] },
    { id: 174, category: "16.userlike.week", text: "지지난주에 결제된 것만 찾아줘", mode: "range", expectedRanges: [weekRange(-2)] },
    { id: 175, category: "16.userlike.week", text: "다다음주 안에 끝날까?", mode: "range", expectedRanges: [weekRange(2)] },
    { id: 176, category: "16.userlike.week", text: "이번 주 월욜 회의록 보여줘", mode: "range", expectedRanges: [exactDay(2026, 4, 13)] },
    { id: 177, category: "16.userlike.week", text: "이번 주 금욜 뭐 했더라", mode: "range", expectedRanges: [exactDay(2026, 4, 17)] },
    { id: 178, category: "16.userlike.week", text: "지난주 화요일 통화 내역 있어?", mode: "range", expectedRanges: [exactDay(2026, 4, 7)] },
    { id: 179, category: "16.userlike.week", text: "지난주 토요일 사진 찾아줘", mode: "range", expectedRanges: [exactDay(2026, 4, 11)] },
    { id: 180, category: "16.userlike.week", text: "다음주 수요일 오후 가능해?", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 22, 12, 0, 18, 0)] },
    { id: 181, category: "16.userlike.week", text: "다음주 일요일엔 쉬지?", mode: "range", expectedRanges: [exactDay(2026, 4, 26)] },
    { id: 182, category: "16.userlike.week", text: "담주 금욜까지 전달해줘", mode: "range", expectedRanges: [exactDay(2026, 4, 24)] },
    { id: 183, category: "16.userlike.week", text: "저저번주 목요일 자료 다시 보내줘", mode: "range", expectedRanges: [exactDay(2026, 4, 2)] },
    { id: 184, category: "16.userlike.week", text: "이번주말에 시간 돼?", mode: "list", expectedList: ["2026-04-18", "2026-04-19"] },
    { id: 185, category: "16.userlike.week", text: "다음주말 여행 갈래?", mode: "list", expectedList: ["2026-04-25", "2026-04-26"] },
    { id: 186, category: "16.userlike.week", text: "지난주말 매출 어땠어?", mode: "list", expectedList: ["2026-04-11", "2026-04-12"] },
    { id: 187, category: "16.userlike.week", text: "돌아오는 월요일까지 제출하면 돼?", mode: "range", expectedRanges: [exactDay(2026, 4, 20)] },
    { id: 188, category: "16.userlike.week", text: "오는 금요일 마감이야?", mode: "range", expectedRanges: [exactDay(2026, 4, 24)] },
    { id: 189, category: "16.userlike.week", text: "다가오는 화요일에 발송해줘", mode: "range", expectedRanges: [exactDay(2026, 4, 21)] },
    { id: 190, category: "16.userlike.week", text: "차주 목요일 가능하냐고 물어봐줘", mode: "range", expectedRanges: [exactDay(2026, 4, 23)] },

    { id: 191, category: "17.userlike.month", text: "이번달 카드값 얼마나 나왔어", mode: "range", expectedRanges: [monthRange(0)] },
    { id: 192, category: "17.userlike.month", text: "지난달 배송비만 따로 보여줘", mode: "range", expectedRanges: [monthRange(-1)] },
    { id: 193, category: "17.userlike.month", text: "내달 초엔 좀 한가할까", mode: "range", expectedRanges: [monthPartRange(2026, 5, "start")] },
    { id: 194, category: "17.userlike.month", text: "저저번 달 매출도 봐야 해", mode: "range", expectedRanges: [monthRange(-2)] },
    { id: 195, category: "17.userlike.month", text: "다다음달 말까지 미뤄도 돼?", mode: "range", expectedRanges: [monthPartRange(2026, 6, "end")] },
    { id: 196, category: "17.userlike.month", text: "올해 1분기보다 2분기가 낫네", mode: "range", expectedRanges: [quarterRange(2026, 1), quarterRange(2026, 2)] },
    { id: 197, category: "17.userlike.month", text: "이번 분기 실적만 다시 봐줘", mode: "range", expectedRanges: [quarterRange(2026, 2)] },
    { id: 198, category: "17.userlike.month", text: "지난 분기 광고비 얼마였어", mode: "range", expectedRanges: [quarterRange(2026, 1)] },
    { id: 199, category: "17.userlike.month", text: "다음 분기에 오픈해도 될까", mode: "range", expectedRanges: [quarterRange(2026, 3)] },
    { id: 200, category: "17.userlike.month", text: "올해 상반기 예산안 다시 열어줘", mode: "range", expectedRanges: [halfRange(2026, 1)] },
    { id: 201, category: "17.userlike.month", text: "작년 하반기 주문량 보여줘", mode: "range", expectedRanges: [halfRange(2025, 2)] },
    { id: 202, category: "17.userlike.month", text: "내년 1분기 말쯤 출시 가능해?", mode: "range", expectedRanges: [quarterPartRange(2027, 1, "late")] },
    { id: 203, category: "17.userlike.month", text: "올해 초에 등록한 건만 보여줘", mode: "range", expectedRanges: [yearPartRange(2026, "early")] },
    { id: 204, category: "17.userlike.month", text: "지난달 말에 끊긴 결제 있어?", mode: "range", expectedRanges: [monthPartRange(2026, 3, "end")] },
    { id: 205, category: "17.userlike.month", text: "이번달 중순쯤 매출 어땠어", mode: "range", expectedRanges: [monthPartRange(2026, 4, "mid")] },
    { id: 206, category: "17.userlike.month", text: "6월 첫째주에 휴가 쓸래", mode: "range", expectedRanges: [weekOfMonthRange(2026, 6, 1)] },
    { id: 207, category: "17.userlike.month", text: "다음달 둘째 주쯤 방문 가능해", mode: "range", expectedRanges: [weekOfMonthRange(2026, 5, 2)] },
    { id: 208, category: "17.userlike.month", text: "2025년 3,4분기 실적 비교해줘", mode: "range", expectedRanges: [quarterRange(2025, 3), quarterRange(2025, 4)] },
    { id: 209, category: "17.userlike.month", text: "2024년 상반기랑 하반기 다 보여줘", mode: "range", expectedRanges: [halfRange(2024, 1), halfRange(2024, 2)] },
    { id: 210, category: "17.userlike.month", text: "올해 공휴일 목록 보여줘", mode: "holidays", expectedListContains: ["2026-01-01", "2026-05-05", "2026-12-25"] },

    { id: 211, category: "18.userlike.absolute", text: "2026-04-01 회의 메모 좀 찾아줘", mode: "range", expectedRanges: [exactDay(2026, 4, 1)] },
    { id: 212, category: "18.userlike.absolute", text: "2026/04/05 결제 내역 보여줘", mode: "range", expectedRanges: [exactDay(2026, 4, 5)] },
    { id: 213, category: "18.userlike.absolute", text: "2026.04.12에 뭐 샀지", mode: "range", expectedRanges: [exactDay(2026, 4, 12)] },
    { id: 214, category: "18.userlike.absolute", text: "2025년 12월 31일 마감 자료 어딨어", mode: "range", expectedRanges: [exactDay(2025, 12, 31)] },
    { id: 215, category: "18.userlike.absolute", text: "2024년 2월 29일에도 운영했어?", mode: "range", expectedRanges: [exactDay(2024, 2, 29)] },
    { id: 216, category: "18.userlike.absolute", text: "0415 입금건만 뽑아줘", mode: "range", expectedRanges: [exactDay(2026, 4, 15)] },
    { id: 217, category: "18.userlike.absolute", text: "20260409 오류 로그 있어?", mode: "range", expectedRanges: [exactDay(2026, 4, 9)] },
    { id: 218, category: "18.userlike.absolute", text: "3월 3일부터 3월 7일까지 예약 현황 보여줘", mode: "range", expectedRanges: [explicitRange(2026, 3, 3, 2026, 3, 7)] },
    { id: 219, category: "18.userlike.absolute", text: "2026년 4월 15일부터 4월 18일까지 방문자 수", mode: "range", expectedRanges: [explicitRange(2026, 4, 15, 2026, 4, 18)] },
    { id: 220, category: "18.userlike.absolute", text: "2025년 12월 29일부터 2026년 1월 2일까지 휴가였어", mode: "range", expectedRanges: [explicitRange(2025, 12, 29, 2026, 1, 2)] },
    { id: 221, category: "18.userlike.absolute", text: "4월 1일부터 10일까지 쓴 돈 합쳐줘", mode: "range", expectedRanges: [explicitRange(2026, 4, 1, 2026, 4, 10)] },
    { id: 222, category: "18.userlike.absolute", text: "2월 14일 주문 내역만 보여줘", mode: "range", expectedRanges: [exactDay(2026, 2, 14)] },
    { id: 223, category: "18.userlike.absolute", text: "2025년 5월 1일부터 5일까지 휴무였나", mode: "range", expectedRanges: [explicitRange(2025, 5, 1, 2025, 5, 5)] },
    { id: 224, category: "18.userlike.absolute", text: "2026년 11월 30일부터 12월 2일까지 출장 잡아줘", mode: "range", expectedRanges: [explicitRange(2026, 11, 30, 2026, 12, 2)] },
    { id: 225, category: "18.userlike.absolute", text: "2025년 6월 한 달치만 보여줘", mode: "range", expectedRanges: [explicitMonthRange(2025, 6)] },
    { id: 226, category: "18.userlike.absolute", text: "2024년 전체 매출 다시 봐줘", mode: "range", expectedRanges: [explicitYearRange(2024)] },
    { id: 227, category: "18.userlike.absolute", text: "작년 5월 5일에 쓴 돈 얼마야", mode: "range", expectedRanges: [exactDay(2025, 5, 5)] },
    { id: 228, category: "18.userlike.absolute", text: "올해 4월 3일 메일함 뒤져줘", mode: "range", expectedRanges: [exactDay(2026, 4, 3)] },
    { id: 229, category: "18.userlike.absolute", text: "2025년 2,3월 광고비 같이 보여줘", mode: "range", expectedRanges: [explicitMonthRange(2025, 2), explicitMonthRange(2025, 3)] },
    { id: 230, category: "18.userlike.absolute", text: "2026년 1월 1일부터 2026년 1월 31일까지 매출표 줘", mode: "range", expectedRanges: [explicitRange(2026, 1, 1, 2026, 1, 31)] },

    { id: 231, category: "19.userlike.datetime", text: "오늘 오후 1시 반에 다시 전화해줘", mode: "datetime", expectedRanges: [pointTime(2026, 4, 18, 13, 30)] },
    { id: 232, category: "19.userlike.datetime", text: "내일 오전 8시 회의실 예약해줘", mode: "datetime", expectedRanges: [pointTime(2026, 4, 19, 8)] },
    { id: 233, category: "19.userlike.datetime", text: "모레 저녁에 밥 약속 잡아줘", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 20, 18, 0, 21, 0)] },
    { id: 234, category: "19.userlike.datetime", text: "다음주 월요일 오후 2시에 면접 있어", mode: "datetime", expectedRanges: [pointTime(2026, 4, 20, 14)] },
    { id: 235, category: "19.userlike.datetime", text: "이번주 금요일 오전 11시에 통화했지?", mode: "datetime", expectedRanges: [pointTime(2026, 4, 17, 11)] },
    { id: 236, category: "19.userlike.datetime", text: "돌아오는 월요일 아침에 출발하자", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 20, 6, 0, 12, 0)] },
    { id: 237, category: "19.userlike.datetime", text: "오는 금요일 저녁에 시간 괜찮아?", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 24, 18, 0, 21, 0)] },
    { id: 238, category: "19.userlike.datetime", text: "다가오는 화요일 오후 4시 미팅 가능해?", mode: "datetime", expectedRanges: [pointTime(2026, 4, 21, 16)] },
    { id: 239, category: "19.userlike.datetime", text: "오늘 밤 11시에 알람 맞춰줘", mode: "datetime", expectedRanges: [pointTime(2026, 4, 18, 23)] },
    { id: 240, category: "19.userlike.datetime", text: "내일 새벽 5시에 깨워줘", mode: "datetime", expectedRanges: [pointTime(2026, 4, 19, 5)] },
    { id: 241, category: "19.userlike.datetime", text: "2026-05-01 오후 6시에 만날래", mode: "datetime", expectedRanges: [pointTime(2026, 5, 1, 18)] },
    { id: 242, category: "19.userlike.datetime", text: "2025년 12월 24일 밤 9시에 출발해", mode: "datetime", expectedRanges: [pointTime(2025, 12, 24, 21)] },
    { id: 243, category: "19.userlike.datetime", text: "4월 18일 15:45에 회의 잡아줘", mode: "datetime", expectedRanges: [pointTime(2026, 4, 18, 15, 45)] },
    { id: 244, category: "19.userlike.datetime", text: "오전 10시부터 11시까지 자리 비워줘", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 18, 10, 0, 11, 0)] },
    { id: 245, category: "19.userlike.datetime", text: "15:30에 다시 전화 좀 줘", mode: "datetime", expectedRanges: [pointTime(2026, 4, 18, 15, 30)] },
    { id: 246, category: "19.userlike.datetime", text: "다음주 화요일 09:00에 출발하자", mode: "datetime", expectedRanges: [pointTime(2026, 4, 21, 9, 0)] },
    { id: 247, category: "19.userlike.datetime", text: "이번주 토요일 새벽 4시 배송 시작이야", mode: "datetime", expectedRanges: [pointTime(2026, 4, 18, 4)] },
    { id: 248, category: "19.userlike.datetime", text: "내일 밤 10시에 공항으로 출발해", mode: "datetime", expectedRanges: [pointTime(2026, 4, 19, 22)] },
    { id: 249, category: "19.userlike.datetime", text: "오늘 아침에 통화 가능해?", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 18, 6, 0, 12, 0)] },
    { id: 250, category: "19.userlike.datetime", text: "다음주 목요일 저녁에 잠깐 볼까", mode: "datetime", expectedRanges: [dateTimeRange(2026, 4, 23, 18, 0, 21, 0)] },

    // 20. 금융 자연어 28개 쿼리 (referenceDate: 2026-04-21)
    {
      id: 251, category: "20.finance", referenceDate: "2026-04-21",
      text: "2025년도 3월부터 2026년도 4월까지의 세금계산서 금액 변화 추이를 시각자료로 보여줘",
      mode: "range",
      expectedRanges: [{ start: "2025-03-01", end: "2026-04-30" }],
    },
    {
      id: 252, category: "20.finance", referenceDate: "2026-04-21",
      text: "작년 3월과 올해 3월의 건수와 매출/매입액으로만 비교해서 보여줄래?",
      mode: "range",
      expectedRanges: [{ start: "2025-03-01", end: "2025-03-31" }, { start: "2026-03-01", end: "2026-03-31" }],
    },
    {
      id: 253, category: "20.finance", referenceDate: "2026-04-21",
      text: "지난달 매출세금계산서와 매입세금계산서의 총액 차이는 얼마인가?",
      mode: "range",
      expectedRanges: [{ start: "2026-03-01", end: "2026-03-31" }],
    },
    {
      id: 254, category: "20.finance", referenceDate: "2026-04-21",
      text: "전체 건수 말고 일자별 합산금액 알려줘",
      mode: "range",
      expectNone: true,
    },
    {
      id: 255, category: "20.finance", referenceDate: "2026-04-21",
      text: "1월부터 3월",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-03-31" }],
    },
    {
      id: 256, category: "20.finance", referenceDate: "2026-04-21",
      text: "지난 1년간",
      mode: "range",
      expectedRanges: [{ start: "2025-04-21", end: "2026-04-21" }],
    },
    {
      id: 257, category: "20.finance", referenceDate: "2026-04-21",
      text: "발급된 법인카드 중 최근 3개월 거래 없는 카드 보여줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-21", end: "2026-04-21" }],
    },
    {
      id: 258, category: "20.finance", referenceDate: "2026-04-21",
      text: "법인카드 1월 매입(이용)내역 있다면 보고서 만들어줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-01-31" }],
    },
    {
      id: 259, category: "20.finance", referenceDate: "2026-04-21",
      text: "씨엔에스 사업장 법인카드 중 1월부터 3월 법인카드 청구내역 리스트 보여줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-03-31" }],
    },
    {
      id: 260, category: "20.finance", referenceDate: "2026-04-21",
      text: "1월부터 현재까지 월별 입출금 합계 정리해줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-04-21" }],
    },
    {
      id: 261, category: "20.finance", referenceDate: "2026-04-21",
      text: "이번 달 거래후잔액이 10만원 이하인 거래 내역 보여줘",
      mode: "range",
      expectedRanges: [{ start: "2026-04-01", end: "2026-04-30" }],
    },
    {
      id: 262, category: "20.finance", referenceDate: "2026-04-21",
      text: "지난달 말일 기준 계좌 잔액이랑 오늘 잔액 비교해줘",
      mode: "range",
      expectedRanges: [{ start: "2026-03-31", end: "2026-03-31" }, { start: "2026-04-21", end: "2026-04-21" }],
    },
    {
      id: 263, category: "20.finance", referenceDate: "2026-04-21",
      text: "이번 달 입금 합계랑 출금 합계 각각 얼마야?",
      mode: "range",
      expectedRanges: [{ start: "2026-04-01", end: "2026-04-30" }],
    },
    {
      id: 264, category: "20.finance", referenceDate: "2026-04-21",
      text: "카드번호 뒤의 4자리가 1872인 카드와 1307인 카드의 26년 1월 사용 내역 보여줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-01-31" }],
    },
    {
      id: 265, category: "20.finance", referenceDate: "2026-04-21",
      text: "작년 1~12월까지 월말 잔액 알려줘 수시입출 계좌만",
      mode: "range",
      expectedRanges: [{ start: "2025-01-01", end: "2025-12-31" }],
    },
    {
      id: 266, category: "20.finance", referenceDate: "2026-04-21",
      text: "4월 1일 기준으로 시재보고서 보여줘",
      mode: "range",
      expectedRanges: [{ start: "2026-04-01", end: "2026-04-01" }],
    },
    {
      id: 267, category: "20.finance", referenceDate: "2026-04-21",
      text: "지금 현재 계좌 잔액 얼마야?",
      mode: "range",
      expectedRanges: [{ start: "2026-04-21", end: "2026-04-21" }],
    },
    {
      id: 268, category: "20.finance", referenceDate: "2026-04-21",
      text: "상반기 법인카드 사용 현황 보고서 만들어줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-06-30" }],
    },
    {
      id: 269, category: "20.finance", referenceDate: "2026-04-21",
      text: "올해 1월 순이익과 2월 순이익 비교해줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-01-31" }, { start: "2026-02-01", end: "2026-02-28" }],
    },
    {
      id: 270, category: "20.finance", referenceDate: "2026-04-21",
      text: "작년 월별로 매출 금액 알려줘",
      mode: "range",
      expectedRanges: [
    ...
    {
      id: 271, category: "20.finance", referenceDate: "2026-04-21",
      text: "어제 18시 기준으로 계좌 잔액 알려줘",
      mode: "datetime",
      expectedRanges: [{ start: "2026-04-20T18:00:00+09:00", end: "2026-04-20T18:00:00+09:00" }],
    },
    {
      id: 272, category: "20.finance", referenceDate: "2026-04-21",
      text: "1분기 법인카드 사용 내역 월별 비교 보고서 만들어줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-03-31" }],
    },
    {
      id: 273, category: "20.finance", referenceDate: "2026-04-21",
      text: "1월부터 3월까지 법인카드 사용 내역 정리해서 보고서 만들어줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-03-31" }],
    },
    {
      id: 274, category: "20.finance", referenceDate: "2026-04-21",
      text: "작년 한 해 전체 거래내역 연간 보고서 만들어줘",
      mode: "range",
      expectedRanges: [{ start: "2025-01-01", end: "2025-12-31" }],
    },
    {
      id: 275, category: "20.finance", referenceDate: "2026-04-21",
      text: "지난 6개월 거래내역 월별로 비교해서 보고서 만들어줘",
      mode: "range",
      expectedRanges: [{ start: "2025-10-21", end: "2026-04-21" }],
    },
    {
      id: 276, category: "20.finance", referenceDate: "2026-04-21",
      text: "1분기(1~3월) 전체 거래내역 요약 보고서 만들어줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-03-31" }, { start: "2026-01-01", end: "2026-03-31" }],
    },
    {
      id: 277, category: "20.finance", referenceDate: "2026-04-21",
      text: "1월부터 3월까지 거래내역 보여줘",
      mode: "range",
      expectedRanges: [{ start: "2026-01-01", end: "2026-03-31" }],
    },
    {
      id: 278, category: "20.finance", referenceDate: "2026-04-21",
      text: "지난달과 이번달 원화 잔액 비교해줘",
      mode: "range",
      expectedRanges: [{ start: "2026-03-01", end: "2026-03-31" }, { start: "2026-04-01", end: "2026-04-30" }],
    },
  ];
...
const commands: Record<string, CommandSpec> = {
  ...
  "realistic-rule-100": {
    description: "룰 전용 realistic benchmark (base 250 + template csv)",
